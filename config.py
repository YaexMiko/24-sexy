...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7245950735:AAEysljzir8Zebq37i22P1wR-DC2oVBKvN0")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002220751997"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5787502520 6768137528 7350721166").split()):
        ADMINS.append(int(x))
except ValueError:
