...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7230623124:AAEFzERI2FkWHN2nF4RB2dcgJ_sJdVCc5kc")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5787502520 6769369582 6768137528").split()):
        ADMINS.append(int(x))
except ValueError:
