...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7945661008:AAEJOcEkaW3j1BkNoB3daYZJwOaJ3QgVVQI")
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "971a7eef7f38784d7cb5accdc2a4ad044c87e25d")
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002045260737"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5787502520 6768137528").split()):
        ADMINS.append(int(x))
except ValueError:
